...
public interface CommonConstant {
    ...
    */
    ...
    public static final String UPLOAD_TYPE_QUNIU = "qiniu";
    ...
    /**
     * 状态，0-待确认，1-已确认，2-已取消，3-已删除
     */
    public static final Integer WISH_STATUS_WAIT_COMFIRE = 0;
    public static final Integer WISH_STATUS_WAIT_COMFIREED = 1;
    public static final Integer WISH_STATUS_WAIT_CANCEL = 2;
    public static final Integer WISH_STATUS_WAIT_DEL = 3;

    public static final Integer WISH_UN_IN = 0;
    public static final Integer WISH_IS_IN = 1;
